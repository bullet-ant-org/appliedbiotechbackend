...
const { createProduct, getAllProducts, getProductBySpecificId, updateProduct, deleteProduct, duplicateProduct, updateDealOfTheWeek, getDealOfTheWeek, updateFeaturedProduct, getFeaturedProduct, manageCartWishlist } = require('../controllers/shopController');
...
router.post('/featured-product', protect, authorize('admin', 'editor'), updateFeaturedProduct);
